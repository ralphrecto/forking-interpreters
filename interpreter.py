...
by the Driver in a buffer of snapshot pids. Once snapshotted, the code
...
class Kernel:
    ...
    def next(self, cell: str):
        ...
        # TODO we need to route the Kernel proc's stdout/stderr *back* to the
        # Driver proc, or at least stdout/stderr generated by this exec.
